...
; !Bank80Freespace = !FREESPACE_80
; !CodeFreespace = !FREESPACE_80+$200
...
!CRASHDUMP = !FREEMEM_7F

!ram_tilemap_buffer = $7E5800 ; 800h bytes

; Defines that shouldn't need changing
...
end_crash_handler_freespace_80:
!FREESPACE_80 := end_crash_handler_freespace_80
